...
import logo from "../../images/imageedit_2_6483490108.png";
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      <div className="md:flex-[0.7] flex-initial justify-center items-center">
        <img src={logo} alt="logo" className="w-32" style={{width: '300px',}}/>
      </div>
      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          ...
          >
            ...
            {["Home", "Central Authority Portal", "Institute Portal"].map(
